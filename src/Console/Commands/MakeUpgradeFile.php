...
namespace App\Services\SystemUpdator\src\Console\Commands;
...
class MakeUpgradeFile extends Command
{
    ...
    public function handle()
    {
        ...
        $file = file_get_contents(__DIR__ . '/../../../../Services/SystemUpdator/src/Templates/versioningFileTemplate.php.txt');
